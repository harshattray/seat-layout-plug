/**
 * @file App.tsx
 * @description The main application component that renders the theater selection and seating layout.
...
const App: React.FC = () => {
  ...
  const selectedConfig = theaterConfigs.find(
    (tc) => tc.id === selectedTheaterId,
  );
